...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toConsumableArray2 = __webpack_require__(330);
	...
	var SerialistVoiceQueue = function () {
		...
		(0, _createClass3.default)(SerialistVoiceQueue, [{
			key: 'queueVoice',
			value: function queueVoice(voice) {
				var _this = this;
	
				(0, _keys2.default)(this.voiceData).forEach(function (key) {
					if (key === 'id') {
						var id = parseInt(voice[key]);
						_this.voiceData[key] = isNaN(id) ? 1 : id;
					} else {
						_this.voiceData[key] = voice[key] || [];
					}
				});
			}
		}, {
			key: 'hasVoiceData',
			value: function hasVoiceData() {
				var _this2 = this;
	
				return (0, _keys2.default)(this.voiceData).filter(function (key) {
					return _this2.voiceData[key].length > 0;
				}).length > 0;
			}
		}, {
			key: 'play',
			...
			value: function advance() {
				...
				this.timer = setTimeout(function () {
					if (_this3.playing && _this3.hasVoiceData()) {
						_this3.sendMidiNoteOff(_this3.note, _this3.velocity, _this3.channel);
						_this3.advance();
					} else {
						_this3.stop();
					}
			...
			key: 'sendMidiNoteOn',
			value: function sendMidiNoteOn(note, velocity, channel) {
				self.postMessage({
					command: 'midi.note.on',
					midi: { note: note, velocity: velocity, channel: channel }
				});
			}
		}, {
			key: 'sendMidiNoteOff',
			value: function sendMidiNoteOff(note, velocity, channel) {
				self.postMessage({
		...
		return SerialistVoiceQueue;
	}();
	
	var SerialistVoiceQueueManager = function () {
		function SerialistVoiceQueueManager() {
			(0, _classCallCheck3.default)(this, SerialistVoiceQueueManager);
	
			this.queues = [];
		}
	
		(0, _createClass3.default)(SerialistVoiceQueueManager, [{
			key: 'play',
			value: function play() {
			...
			key: 'sendTransportState',
			value: function sendTransportState(state) {
				self.postMessage({
		...
		return SerialistVoiceQueueManager;
	}();
	
	var manager = new SerialistVoiceQueueManager();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = !__webpack_require__(51) && !__webpack_require__(96)(function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
	__webpack_require__(68)(IteratorPrototype, __webpack_require__(41)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(66);
	// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
	$export($export.S + $export.F * !__webpack_require__(51), 'Object', {defineProperty: __webpack_require__(53).f});
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(351)('keys', function(){
	  return function keys(it){
	    return $keys(toObject(it));
	  };
	});
...
/***/ }
/******/ ]);
//# sourceMappingURL=serialist-player-worker.js.map