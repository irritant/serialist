				...
				<Overlay className="help-overlay">
					...
					<div className="help-overlay-content">
						<ul>
							...
							<li>Serialist uses the <a href="https://github.com/irritant/serialist-grammar#data" target="_blank">serialist-grammar Data</a> syntax to send MIDI CC messages.</li>
							<li>Label your data rows in the format <em>cc&lt;CC number&gt;</em> (e.g. <em>cc1(32 64 96)</em> defines a row with values 32, 64 and 96 using CC 1).</li>
							...
							<li>Modify your command and re-evaluate as often as you like. Your previous commands will be listed in the <em>Command History</em> field.</li>
							<li>The last 50 outgoing MIDI messages are listed in the <em>MIDI History</em> field.</li>
							...
							<li>After playing, save any interesting commands by copying them from the <em>Command History</em> field to a text file on your computer.</li>
						</ul>
					</div>
